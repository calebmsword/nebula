# Parsec
Nebula is a collection of requestor factories and utilities for creating robust requestors.
When used with Parsec, it becomes the most ergonomic way to use requestors to manage asychronous code in JavaScript.
